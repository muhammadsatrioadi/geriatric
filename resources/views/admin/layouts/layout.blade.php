            ...
            <div class="sidebar-wrapper scrollbar scrollbar-inner">
                <div class="sidebar-content">
                    <ul class="nav nav-secondary">
                        ...
                        <li class="nav-item {{ request()->routeIs('admin.pasiens*') ? 'active' : '' }}">
                        ...
                        <li class="nav-item {{ request()->routeIs('admin.foundations*') ? 'active' : '' }}">
                                        ...
                                        <li>
                                            <div class="user-box">
                                                <div class="avatar-lg"><img
                                                        src="@if (auth()->user()->profile_photo_path) {{ asset('storage/' . auth()->user()->profile_photo_path) }}@else{{ asset('admin/img/profile.jpg') }} @endif"
            ...
            <div class="container">
                <div class="page-inner">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="fw-bold mb-3">@yield('admin_page_title')</h3>
                        </div>
                    </div>
