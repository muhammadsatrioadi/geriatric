...
@section('superadmin_layout')
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('superadmin.foundations.create') }}" class="btn btn-primary">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('superadmin.foundations.show', $foundation) }}" 
                                           class="btn btn-sm btn-info" title="Detail">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        <a href="{{ route('superadmin.foundations.edit', $foundation) }}" 
                                           class="btn btn-sm btn-warning" title="Edit">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <form action="{{ route('superadmin.foundations.toggle', $foundation) }}" 
                                        ...
                                        <form action="{{ route('superadmin.foundations.destroy', $foundation) }}" 
                                              method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
