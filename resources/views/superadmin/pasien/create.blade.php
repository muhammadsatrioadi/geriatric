...
@section('superadmin_layout')
    <div class="col-md-12">
        <form action="{{ route('superadmin.pasiens.store') }}" method="POST"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="form-group">
                                <label for="single_leg">Single Leg Balance (Mata Terbuka/Tertutup)</label>
                                <div class="input-group">
                                    <input type="text" name="single_leg"
                                        class="form-control @error('single_leg') is-invalid @enderror"
                                        placeholder="Durasi Terbuka/Tertutup" value="{{ old('single_leg') }}" />
