            ...
            <div class="card">
                <div class="card-header d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                    ...
                    <div class="ms-md-auto py-2 py-md-0">
                        ...
                        <a href="{{ route('superadmin.pasiens.create') }}" class="btn btn-primary btn-round">Tambah Pasien</a>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            <tbody class="text-center">
                                @forelse($pasiens as $pasien)
                                    <tr>
                                        ...
                                        <td>{{ $pasien->kategori_stroke }}</td>
                                        <td>{{ $pasien->riwayat_jatuh }}</td> --}}
                                        <td>                                            
                                            <a href="{{ route('superadmin.pasiens.show', $pasien->id) }}"
                                                class="btn btn-sm btn-primary" title="Detail">
                                                <i class="fa fa-info-circle"></i>
                                            </a>
                                            <a href="{{ route('superadmin.pasiens.manage', $pasien->id) }}"
                                                class="btn btn-sm btn-label-info" title="Lihat">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                             <form action="{{ route('superadmin.pasiens.destroy', $pasien->id) }}" method="POST"
