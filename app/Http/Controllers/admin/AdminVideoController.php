...
class AdminVideoController extends Controller
{
    ...
    {
        $pasiens = pasien::all();
        return view('admin.video.create', compact('pasiens'));
    }
    ...
    {
        $pasiens = pasien::all();
        return view('admin.video.edit', compact('video', 'pasiens'));
    }
    ...
    public function toggleStatus(Video $video)
    {
        ...
        return redirect()->route('admin.videos.index')->with('success', 'Status video berhasil diubah.');
    }
}
